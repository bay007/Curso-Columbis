...
def cuenta_caracteres(frase):  
        ...
        resultado_minus = {llave : valor for llave, valor in alfabeto_minus.items() if valor >0 }
        resultado_mayus = {llave : valor for llave, valor in alfabeto_mayus.items() if valor >0 }


        #print(resultado_minus)
 
        return  resultado_minus, resultado_mayus
                

    
palabra_frase = input("Escribe una palabra o frase:")
print(cuenta_caracteres(palabra_frase))
