...
SECRET_KEY = '$__ys*++l-*td%%5!b#)*u(z4#^*su7n*9ygj@+0j-@#12z((0'
...
INSTALLED_APPS = [
    # El sitio administrativo. Panel de aministración..
...
# La siguiente configuración es para una base de datos postgres
# DATABASES = {
#     'default': {
...
# Por ahora solo usaremos la base de datos sql lite.
DATABASES = {
    'default': {
